...
def update_graph(value, slider_value, selectedData, prevLayout, mapControls):
    ...
    return go.Figure(
        data=Data([
            ...
            Scattermapbox(
                lat=["34.281566", "34.264633", "34.270177", "35.067845", "34.415558", "34.368749",
                     "34.368749", "34.344983", "34.422910", "34.540876"],
                lon=["132.319662", "132.666228", "132.593462", ", 132.946495",
                ...
                dict(
                    buttons=([
                        ...
                        dict(
                            args=[{
                                    'mapbox.zoom': 11,
                                    'mapbox.center.lon': '132.946495',
                                    'mapbox.center.lat': '35.067845',
                                    'mapbox.bearing': 0,
                                    'mapbox.style': 'dark'
                                }],
                            label='毛無山',
